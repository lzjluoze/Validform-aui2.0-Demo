...
/// <summary>
    ...
    public abstract class DbHelperSQLite
    {
        ...
        // public static string connectionString = "Data Source= c:\\JF.db";
        public DbHelperSQLite(string con)
        {
        ...
        public static int ExecuteSqlInsertImg(string strSQL, byte[] fs)
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                ...
                SQLiteParameter myParameter = new SQLiteParameter("@fs", DbType.Int16);
        ...
        /// </summary>
        public static object GetSingle(SQLiteConnection connection, SQLiteTransaction trans, string SQLString)
        {
            using (SQLiteCommand cmd = new SQLiteCommand(SQLString, connection))
            {
                try
        ...
        /// </summary>
        public static DataSet Query(SQLiteConnection connection, SQLiteTransaction trans, string SQLString)
        {
            DataSet ds = new DataSet();
            try
            {
        ...
        /// <param name="SQLString">SQL语句</param>
        /// <returns>影响的记录数</returns>
        public static int ExecuteSql(SQLiteConnection connection, SQLiteTransaction trans, string SQLString)
        {
            using (SQLiteCommand cmd = new SQLiteCommand(SQLString, connection))
            {
                try
        ...
        /// <param name="trans">SQLiteTransaction对象</param>
        /// <param name="SQLString">SQL语句</param>
        /// <param name="cmdParms">SQLiteParameter对像</param>
        /// <returns>受影响的行</returns>
        public static int ExecuteSql(SQLiteConnection connection, SQLiteTransaction trans, string SQLString, params SQLiteParameter[] cmdParms)
        {
            using (SQLiteCommand cmd = new SQLiteCommand())
            {
                try
        ...
        /// 2012-2-21新增结合事务
        /// </summary>
        public static DataSet Query(SQLiteConnection connection, SQLiteTransaction trans, string SQLString, params SQLiteParameter[] cmdParms)
        {
            SQLiteCommand cmd = new SQLiteCommand();
            PrepareCommand(cmd, connection, trans, SQLString, cmdParms);
            using (SQLiteDataAdapter da = new SQLiteDataAdapter(cmd))
